...
public class MemberDTO {
	...
	public boolean matchPassword(String memberPwd) {
		return this.memberPwd.equals(memberPwd);
	}
	...
	public String toString() {
		return String.format(
				...
				memberId, memberPwd, memberPwdConfirm, memberName, memberPh, memberBirth, memberGender==Gender.FEMALE?"여자":"남자", memberPwdQ,
